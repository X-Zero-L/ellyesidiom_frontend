    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-white dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center">
          <h2 className="mt-6 text-3xl font-extrabold text-gray-900 dark:text-white">验证您的账户</h2>
        </div>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            >
              <button
                ...
                className={`w-full ${isLoading || currentStep !== 1
              ...
              {verificationCommand && (
                <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div
                    ...
                    className={`flex items-center justify-between bg-white p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 active:bg-gray-100 transition-colors duration-200 ${isCopied ? 'bg-green-50 border-green-200' : ''
                      } touch-action-manipulation`}
                  >
                    <code className="text-xs sm:text-sm text-gray-800 break-all mr-2">{verificationCommand}</code>
                    <div className={`flex-shrink-0 ${isCopied ? 'text-green-500' : 'text-gray-400'
                      }`}>
  ...
  return (
    <div className={`${isActive ? 'opacity-100' : 'opacity-60'} transition-opacity duration-300`}>
      <div className="flex items-center mb-2 sm:mb-3">
        <div
          className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center mr-2 sm:mr-3 ${isCompleted ? 'bg-green-500' : isActive ? 'bg-blue-500' : 'bg-gray-300'
